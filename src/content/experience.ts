    ...
    roles: [
      {
        ...
        endDate: "present",
        responsibilities: [
          "Led a team of 5+ engineers in developing a SaaS platform for vacancy management and applicant tracking",
          "Implemented serverless platform for employment verification using Web Components, AWS Lambda, API Gateway, RDS, S3, SNS/SQS and other AWS services",
    ...
    roles: [
      {
        ...
        responsibilities: [
          ...
          "Implementing SAGA patterns for distributed transactions across microservices",
      ...
      },
      {
        ...
        responsibilities: [
          ...
          "Contributed in writing CloudFormation templates for infrastructure as code (IaC) to automate the deployment of AWS resources",
        ],
